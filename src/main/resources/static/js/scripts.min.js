...
$(function(){var e=$("#menu").mmenu({extensions:{all:["pagedim-black","position-right","theme-white"],"(max-width: 400px)":["fullscreen"],"(min-height: 768px)":["listview-large"]},navbars:[{position:"top"}],navbar:{title:"UniService"}},{clone:!0}),i=$("#btn-menu"),n=e.data("mmenu");i.on("click",function(){n.open(),n.bind("open:finish",function(){setTimeout(function(){i.addClass("is-active")},100)}),n.bind("close:finish",function(){setTimeout(function(){i.removeClass("is-active")},100)})}),$(".owl-carousel").owlCarousel({loop:!0,margin:20,responsiveClass:!0,responsive:{0:{items:2},600:{items:3},1000:{items:5}}}),$("#distributeScoresForm").validate({rules:{score:{required:!0,number:!0,digits:!0}}}),$("#addScoresForm").validate({rules:{score:{required:!0,number:!0,digits:!0}}})});